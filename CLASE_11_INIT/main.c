...
int main()
{
    ...
    con_ingresoForzado(contrataciones,CANTIDAD_CONTRATACIONES,"peliculas","1",3,0);
    con_ingresoForzado(contrataciones,CANTIDAD_CONTRATACIONES,"peliculas","9",20,1);
    con_ingresoForzado(contrataciones,CANTIDAD_CONTRATACIONES,"revistas","3",5,2);
    con_ingresoForzado(contrataciones,CANTIDAD_CONTRATACIONES,"espectro","8",6,0);
    con_ingresoForzado(contrataciones,CANTIDAD_CONTRATACIONES,"horror","5",10,1);
    con_ingresoForzado(contrataciones,CANTIDAD_CONTRATACIONES,"XXX","6",3,2);
    con_ingresoForzado(contrataciones,CANTIDAD_CONTRATACIONES,"XXX","7",40,2);
